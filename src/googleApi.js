...
class googleApi {
	getPlaces(category, callback) {
		...
		fetch(`https://maps.googleapis.com/maps/api/place/nearbysearch/json?key=${Config.apiKey}&location=48.8569613,2.3687517&rankBy=distance&radius=400&types=${types}`)
    .then(res => res.json())
    .then(places => {
